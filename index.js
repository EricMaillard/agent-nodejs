...
function _credentials(options) {
    ...
    var res = await request('GET', baseUrl + "?Api-Token=" + options.apitoken, { timeout: 5000, socketTimeout: 5000 });
    ...
    */
    var credentials = { tenantUUID:options.tenantUUID,  tenantToken:options.tenantToken, communicationEndpoints:options.communicationEndpoints}
    return credentials;
}
...
function _agentOptions(options) {
    ...
    return {
        server: credentials.communicationEndpoints,
